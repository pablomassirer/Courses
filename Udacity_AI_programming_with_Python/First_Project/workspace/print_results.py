...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("\n\n*** Results Summary for CNN Model Architecture",model.upper(), 
          "***", '\n')
    print("{:40}: {:>30}".format('N Images', results_stats_dic['n_images']))
    print("{:40}: {:>30}".format('N Dog Images', results_stats_dic['n_dogs_img']))
    ...
    #          results_stats_dic
    #
    print("{:40}: {:>30}".format('N Not-dog Images', results_stats_dic['n_notdogs_img']))


    # Prints summary statistics (percentages) on Model Run
    print("{:40}: {:>30.3f}".format('PCT Match', results_stats_dic['pct_match']))
    print("{:40}: {:>30.3f}".format('PCT Correct Dogs', results_stats_dic['pct_correct_dogs']))
    print("{:40}: {:>30.3f}".format('PCT Correct Dog Breeds', results_stats_dic['pct_correct_breed']))
    print("{:40}: {:>30.3f}".format('PCT Correct Not Dogs', results_stats_dic['pct_correct_notdogs']))
    ...
    for key in results_stats_dic:
        ...
        #
        if key[0].lower() == 'p':
            print('{:40}: {:>30.3f}'.format('PCT ' + key, results_stats_dic[key]))
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if (results_dic[key][3] == 1 and results_dic[key][4] == 0 
                or results_dic[key][3] == 0 and result_dic[key][4] == 1):
                print('Pet Label: {:10}\nClassifier Label {:10}'.format(results_dic[0], results_dic[1]))
